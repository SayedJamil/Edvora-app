...
function leftcard({ searchResults }) {
    ...
    return (
        <div className="h-72 w-60 bg-[#131313] rounded-2xl p-4">
            ...
            <Dropdown text='Product' className="rounded-md p-2 bg-[#232323] hover:border-[#232323] focus:outline-none appearance-none outline-none text-white w-full justify-center text-lg items-center mb-2 border-[#232323]">
                <Dropdown.Menu className="bg-[#232323] border-[#232323]!important outline-none rounded-md">
                    {
                        removeDups(list).map((item) =>
                            <div>
                                <Dropdown.Item text={item} className="bg-[#232323] p-2 border-[#232323]" />
                            </div>
