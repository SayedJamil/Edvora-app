...
function RightCard({ searchResults }) {
    return (
        <div className="ml-10 flex-grow min-w-max overflow-x-scroll">
            ...
            <h2 className="text-2xl text-white">Product Name</h2>
            <div className="w-full h-0.5 bg-white opacity-50"></div>
            <div className="h-56 min-w-max rounded-3xl bg-[#131313] mt-5 mb-10 flex items-center overflow-x-scroll ">
                {
