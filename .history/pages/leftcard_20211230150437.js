...
function leftcard({ searchResults }) {
    ...
    return (
        <div className="h-72 w-60 bg-[#131313] rounded-2xl p-4">
            ...
            <Dropdown text='Product' className="rounded-md p-2s bg-[#232323] hover:border-[#232323] focus:outline-none appearance-none outline-none text-white w-full justify-center text-lg items-center mb-2">
                <Dropdown.Menu>
                    {
                        removeDups(list).map((item) =>
                            <div>
